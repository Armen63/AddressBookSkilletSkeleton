package am.aca.AddressBookSkeleton.resource;
...
public class Statics {
    ...
    public String wrongCommand = "You have entered Wrong command.";
    public String help ="If you want to register ,you need command 'Sign Up'\n"
    ...
    public String invalidCommand = ">>Invalid command. Please write 'Help' command for see command list";
    public String writeSignOut = ">>You successful sign outed from account";
}
